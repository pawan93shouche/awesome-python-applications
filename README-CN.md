...
作为开发人员，我们每天都与代码打交道。但对更广泛的公众来说，重要的是应用程序。在构建我们自己的应用程序时，开源Python应用程序是实践模式的金矿，我们知道这些模式可以一起工作。<!-- the x-y problem, at scale? -->

本文档由**182**开源Python应用程序排列而成

的话题。如果你有一个补充或发现一些信息缺失，
...
1. <a href="#tag-internet">IT</a> *(9)*
1. <a href="#tag-audio">音频</a> *(9)*
1. <a href="#tag-video">视频</a> *(4)*
1. <a href="#tag-graphics">图像</a> *(7)*
1. <a href="#tag-games">游戏</a> *(4)*
1. <a href="#tag-productivity">效率工具</a> *(10)*
1. <a href="#tag-organization">组织工具</a> *(8)*
1. <a href="#tag-communication">交流</a> *(19)*
1. <a href="#tag-education">教育</a> *(4)*
1. <a href="#tag-science">科学</a> *(8)*
...
## <a id="tag-graphics" href="#tag-graphics">Graphics</a>
  ...
  1. **PhotoCollage** - ([Repo](https://github.com/adrienverge/PhotoCollage)) 自动布局照片拼贴，以填写给定的海报空间。ubuntu 可以运行，但排版后像素被压缩.windowN 中PIP 安装错误 `(gtk)`
